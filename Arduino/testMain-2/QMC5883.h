...
{
  public:
    DFRobot_QMC5883(TwoWire*pWire = &Wire, uint8_t I2C_addr = 0x0D);
    /**
     * @fn begin
     * @brief Sensor init
    ...
    /**
     * @fn Setup
     * @brief begin and set parameters
     * @return void
     * @retval none
     * @author Betty Cheng
    */
    ...
    /**
     * @fn setHeadingDegrees
     * @brief Set the sensor range
     */
    void setHeadingDegrees(void);
     ...
     * @brief get HeadingDegress of v
     * @return float
     * @retval the heading degree of v 
     * @author Betty Cheng
    */
    float getHeadingDegrees(void){return v.HeadingDegress;}


    /**
     * @fn getRelativeDegrees
     * @brief get Relative HeadingDegrees
     * @return float
     * @retval the heading degrees of v relative to the north of the site
     * @author Betty Cheng
    */
    float getRelativeDegrees(void);
